  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        bubble: {
          contact: "hsl(var(--bubble-contact))",
          "contact-foreground": "hsl(var(--bubble-contact-foreground))",
          ...
          note: "hsl(var(--bubble-note))",
          "note-foreground": "hsl(var(--bubble-note-foreground))",
          system: "hsl(var(--bubble-system))",
          "system-foreground": "hsl(var(--bubble-system-foreground))",
        },
        status: {
        ...
        "unread-badge": "hsl(var(--unread-badge))",
      },
      borderRadius: {
        lg: "var(--radius)",
